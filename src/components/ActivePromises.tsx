      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-1.5 p-1.5 rounded-2xl bg-white/[0.03] border border-white/10 overflow-x-auto">
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${activeFilterTab === 'ALL'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${activeFilterTab === 'LOCKED'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${activeFilterTab === 'VERIFIED'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${activeFilterTab === 'FULFILLED'
