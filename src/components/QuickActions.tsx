    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2.5 p-3.5 rounded-2xl border transition-all text-xs font-semibold active:scale-95 ${activeFilter === 'ALL'
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2.5 p-3.5 rounded-2xl border transition-all text-xs font-semibold active:scale-95 ${activeFilter === 'VERIFIED'
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2.5 p-3.5 rounded-2xl border transition-all text-xs font-semibold active:scale-95 ${activeFilter === 'CLAIMABLE'
              ? 'bg-[#CFFF00]/15 border-[#CFFF00]/50 text-[#CFFF00] shadow-glowLime'
              : 'bg-white/[0.03] hover:bg-white/[0.06] border-white/10 text-[#9AA4B2]'
            }`}
        >
