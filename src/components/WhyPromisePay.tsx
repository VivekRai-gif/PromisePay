  ...
  return (
    <section className="mb-12">
      <div className="text-center max-w-xl mx-auto mb-8">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-500/10 text-purple-300 text-xs font-semibold mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {cards.map((card, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`group p-6 rounded-3xl glass-panel border border-white/10 ${card.borderColor} transition-all duration-300 hover:-translate-y-1`}
            >
