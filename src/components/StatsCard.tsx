...
export const StatsCard: React.FC<StatsCardProps> = ({ stats }) => {
  return (
    <div className="relative overflow-hidden rounded-3xl p-6 sm:p-8 glass-panel border border-white/10 shadow-card mb-8">
      {/* Background ambient glow inside card */}
      <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-bl from-purple-600/15 via-pink-600/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-indigo-600/10 via-transparent to-transparent rounded-full blur-2xl pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-white/10">
        ...
        {/* Primary Stat Block */}
        <div className="flex items-baseline gap-3 bg-white/[0.03] p-3.5 px-5 rounded-2xl border border-purple-500/20 backdrop-blur-md">
          <span className="text-xs text-slate-400 font-medium">Total Locked:</span>
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="text-sm font-bold text-purple-400">MON</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all">
          ...
          <span className="text-[11px] text-amber-400/90 font-medium mt-1">Currently locked</span>
        </div>
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all">
          ...
          <span className="text-[11px] text-emerald-400/90 font-medium mt-1">Released successfully</span>
        </div>
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all">
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-xs text-purple-400 font-semibold">MON</span>
          </div>
          <span className="text-[11px] text-purple-400/90 font-medium mt-1">All-time volume</span>
        </div>
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all">
          <div className="flex items-center justify-between text-slate-400 mb-2">
            ...
            <div className="w-7 h-7 rounded-xl bg-pink-500/10 flex items-center justify-center text-pink-400">
